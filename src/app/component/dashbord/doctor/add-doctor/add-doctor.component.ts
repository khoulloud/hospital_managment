...
import { FormBuilder, FormGroup, Validators, FormControl } from '@angular/forms'; // Importation de FormBuilder, FormGroup et FormControl
...
export class AddDoctorComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.form = this.fb.group({
      ...
      mobile: [this.mobile, [Validators.required, Validators.maxLength(8), Validators.minLength(8)]],
